...
def solar_education(request):
    ...
    solar_counter = HostEvent.objects.filter(date__range=["2020-03-24", "2020-04-30"]).count()
    state_counter = HostEvent.objects.filter(date__range=["2020-03-24", "2020-04-30"]).values('state').annotate(the_count=Count('state')).count()
