...
CELERY_IMPORTS = ('revolv.tasks.reinvestment_allocation', 'revolv.tasks.reinvestment_rollover','revolv.tasks.send_signup_info')
...
CELERYBEAT_SCHEDULE = {
    ...
    "send_signup_info": {
        "task": "revolv.tasks.sfdc.send_signup_info",
    }
}
